...
class Encoding(object):
    ...
    def parse_partial(self, raw):
        ...
        Raises
        ------
        ~udfsapi.exceptions.DecodingError
    ...
    def encode(self, obj):
        ...
        Raises
        ------
        ~udfsapi.exceptions.EncodingError
...
# encodings supported by the udfs api (default is JSON)
__encodings = {
    Dummy.name: Dummy,
    Json.name: Json,
    Pickle.name: Pickle,
...
def get_encoding(name):
    ...
    Raises
    ------
    ~udfsapi.exceptions.EncoderMissingError
