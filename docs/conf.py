...
# -*- coding: utf-8 -*-
#
# Python udfs API documentation build configuration file, created by
...
with open(os.path.join(sys.path[0], 'udfsapi', 'version.py')) as file:
    exec(file.read())
...
project = 'Python udfs API'
copyright = '2016, py-udfs-api team'
author = 'py-udfs-api team'
...
#html_title = 'Python udfs API v0.2.4'
...
latex_documents = [
    (master_doc, 'PythonudfsAPI.tex', 'Python udfs API Documentation',
     'py-udfs-api team', 'manual'),
]
...
man_pages = [
    (master_doc, 'py-udfs-api', 'Python udfs API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'py-udfs-api', 'Python udfs API Documentation',
     author, 'py-udfs-api', 'One line description of project.',
     'Miscellaneous'),
]
